...
package net.mcreator.easycrafting.world.dimension;
...
import net.mcreator.easycrafting.item.DIamoItem;
...
public class DIamoDimension extends OpitemsModElements.ModElement {
	@ObjectHolder("opitems:d_iamo_portal")
	public static final CustomPortalBlock portal = null;
	public DIamoDimension(OpitemsModElements instance) {
		super(instance, 14);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("opitems:d_iamo"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("d_iamo_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("d_iamo_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("d_iamo_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new DIamoItem().setRegistryName("d_iamo"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("opitems:d_iamo"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("opitems:d_iamo")));
				} else {
					entity.func_242279_ag();
