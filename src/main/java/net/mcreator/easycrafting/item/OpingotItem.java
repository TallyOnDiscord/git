...
public class OpingotItem extends OpitemsModElements.ModElement {
	@ObjectHolder("opitems:opingot")
	public static final Item block = null;
	public OpingotItem(OpitemsModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("OP INGOT"));
		}
	}
}
